...
void new_fit(){
  TFile *fileData = TFile::Open("newsc_data.root");  //sc_data.root
  TFile *fileMC1 = TFile::Open("newsc2_WZ.root");   // sc2_WZ.root
  TFile *fileMC2 = TFile::Open("newsc2_ZZ.root"); // sc2_ZZ.root
