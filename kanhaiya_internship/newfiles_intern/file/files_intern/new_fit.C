...
void new_fit(){
   TFile *fileData = TFile::Open("newsc_data.root");
   TFile *fileMC1 = TFile::Open("newsc2_WZ.root");
   TFile *fileMC2 = TFile::Open("newsc2_ZZ.root");
   ...
   fit->SetRangeX(1,22);                    // use only from the 7th bin to 22th that has non zero entry.
   // fit->SetWeight(0,mc3);
   // fit->SetWeight(1,mc4);
